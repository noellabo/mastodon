...
ActiveRecord::Schema.define(version: 20180514112228) do
  ...
  create_table "statuses", id: :bigint, default: -> { "timestamp_id('statuses'::text)" }, force: :cascade do |t|
    ...
    t.index ["account_id", "visibility", "id"], name: "index_statuses_on_account_id_and_visibility_and_id", order: { id: :desc }
