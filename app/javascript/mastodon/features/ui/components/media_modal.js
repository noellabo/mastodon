    ...
    return (
      <div className='modal-root__modal media-modal'>
        ...
        <div className='media-modal__content'>
          ...
          <ReactSwipeableViews containerStyle={containerStyle} onChangeIndex={this.handleSwipe} index={index} animateHeight={media.every(image => image.hasIn(['meta', 'original', 'height']))}>
            {content}
          </ReactSwipeableViews>
        </div>
